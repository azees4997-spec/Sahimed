        ...
        <div className="space-y-4">
          {isLoading ? (
              ...
              <Card key={order.id} className="rounded-[32px] border-none shadow-sm overflow-hidden bg-white hover:shadow-xl transition-all duration-300 active:scale-[0.98]">
                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {/* Logistics */}
                    <div className="space-y-4">
                       <div className="bg-gray-50/50 p-4 rounded-[20px] border border-gray-100/50">
                          ...
                          <div className="flex items-start gap-3">
                            <Clock className="w-3 h-3 text-orange-400 shrink-0 mt-0.5" />
                            <div>
                       ...
                       <div className="flex gap-2">
                          <Button className="flex-1 rounded-full h-10 font-black uppercase text-[9px] tracking-widest shadow-md active:scale-95 transition-all">Quick Refill</Button>
            ...
            <div className="text-center py-20 bg-white rounded-[32px] border border-gray-100 shadow-sm">
               ...
               <Link href="/">
                 <Button className="rounded-full px-10 h-14 font-black text-sm shadow-xl shadow-primary/20 uppercase tracking-widest active:scale-95">Start Shopping</Button>
               </Link>
            </div>
          )}
        </div>
