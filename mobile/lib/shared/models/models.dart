...
class ProductModel {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) {
    ...
    return ProductModel(
      ...
      safetyAdvice: json['safetyAdvice'] ?? json['moleculeData']?['safetyAdvice'] ?? json['moleculeData']?['safety'],
      howToUse: json['howToUse'] ?? json['moleculeData']?['howToUse'] ?? json['moleculeData']?['use'],
      pregnancyInteraction: json['pregnancyInteraction'] ?? json['moleculeData']?['pregnancyInteraction'] ?? json['moleculeData']?['pregnancy'],
      lactationInteraction: json['lactationInteraction'] ?? json['moleculeData']?['lactationInteraction'] ?? json['moleculeData']?['lactation'],
      drivingInteraction: json['drivingInteraction'] ?? json['moleculeData']?['drivingInteraction'] ?? json['moleculeData']?['driving'],
      kidneyInteraction: json['kidneyInteraction'] ?? json['moleculeData']?['kidneyInteraction'] ?? json['moleculeData']?['kidney'],
      liverInteraction: json['liverInteraction'] ?? json['moleculeData']?['liverInteraction'] ?? json['moleculeData']?['liver'],
