    ...
    <div className="w-full bg-white border-b border-slate-100 shadow-sm relative z-30">
      <div className="w-full px-4 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between gap-1 overflow-x-auto scrollbar-hide py-2">
          ...
          {/* Quick Pill Badge */}
          <div className="flex items-center gap-1.5 px-3 py-1 bg-primary/10 border border-primary/20 rounded-full shrink-0 mr-2">
            <Sparkles className="w-3.5 h-3.5 text-primary" />
            <span className="text-[11px] font-black uppercase tracking-wider text-primary">Top Categories</span>
          </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown className={`w-3 h-3 transition-transform duration-200 ${isHovered ? 'rotate-180 text-white' : 'text-slate-400'}`} />
                </Link>
