      ...
      <main className="max-w-[1200px] mx-auto px-3 sm:px-10 py-4 sm:py-6">
        ...
        <section className="bg-white rounded-[32px] sm:rounded-[40px] p-6 sm:p-16 shadow-xl border border-gray-100 overflow-hidden">
          <Tabs defaultValue="clinical" className="w-full">
            <TabsList className="bg-gray-100 p-1 rounded-full h-10 sm:h-16 w-full max-w-[600px] flex mx-auto mb-8 sm:mb-16 border border-gray-200/50 shadow-inner">
              <TabsTrigger value="clinical" className="flex-1 rounded-full h-full font-black text-[8px] sm:text-xs tracking-[0.1em] data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-primary transition-all">Clinical</TabsTrigger>
              <TabsTrigger value="safety" className="flex-1 rounded-full h-full font-black text-[8px] sm:text-xs tracking-[0.1em] data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-primary transition-all">Safety</TabsTrigger>
              <TabsTrigger value="interactions" className="flex-1 rounded-full h-full font-black text-[8px] sm:text-xs tracking-[0.1em] data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-primary transition-all">Risks</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="safety" className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-2">
               <div className="bg-orange-50 border border-orange-100 p-5 rounded-[24px] flex gap-3 shadow-sm">
                 <div className="w-10 h-10 sm:w-16 bg-white rounded-[16px] flex items-center justify-center shrink-0 border border-orange-200/50 shadow-sm"><AlertTriangle className="w-5 h-5 text-orange-600" /></div>
               ...
               <div className="bg-blue-50 border border-blue-100 p-5 rounded-[24px] flex gap-3 shadow-sm">
                 <div className="w-10 h-10 sm:w-16 bg-white rounded-[16px] flex items-center justify-center shrink-0 border border-blue-200/50 shadow-sm"><Stethoscope className="w-5 h-5 text-blue-600" /></div>
            ...
            <TabsContent value="interactions" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 animate-in fade-in slide-in-from-bottom-2">
              {[
                ...
                <div key={i} className="bg-white border border-gray-100 p-4 rounded-[24px] flex items-start gap-3 hover:shadow-md transition-all">
