'use server';
/**
 * @fileOverview An AI agent for analyzing prescription images for legibility and extracting medication details.
 *
 * - prescriptionAnalysisAndPreFill - A function that handles the prescription analysis and pre-fill process.
 * - PrescriptionAnalysisAndPreFillInput - The input type for the prescriptionAnalysisAndPreFill function.
 * - PrescriptionAnalysisAndPreFillOutput - The return type for the prescriptionAnalysisAndPreFill function.
 */
...
export type PrescriptionAnalysisAndPreFillInput = z.infer<
  typeof PrescriptionAnalysisAndPreFillInputSchema
>;
...
export type PrescriptionAnalysisAndPreFillOutput = z.infer<
  typeof PrescriptionAnalysisAndPreFillOutputSchema
>;

export async function prescriptionAnalysisAndPreFill(
  input: PrescriptionAnalysisAndPreFillInput
): Promise<PrescriptionAnalysisAndPreFillOutput> {
  return prescriptionAnalysisAndPreFillFlow(input);
}
...
const prescriptionAnalysisAndPreFillFlow = ai.defineFlow(
  {
    name: 'prescriptionAnalysisAndPreFillFlow',
    inputSchema: PrescriptionAnalysisAndPreFillInputSchema,
    outputSchema: PrescriptionAnalysisAndPreFillOutputSchema,
  },
  async input => {
